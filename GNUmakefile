...
integration:
	export PYTHONPATH=`pwd` && python2.7 -m pytest -v --instafail `pwd`/test/integration_test_suite/integration_test.py --html=./report/integration_test.html --junitxml=./report/integration_test.xml
