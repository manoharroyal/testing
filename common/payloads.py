...
class CustomerProfileServicePayload(object):
    ...
    def customer_profile_payload(self, title="Test_Job",
                                 ...
                                 cont_num=344245224, zipcode=1234,
                                 country='US', state='IOWA',
                                 city='Cedar Rapids', contact_name='jeyanthi'):
...
class Inventoryservicepayload(object):
    ...
    def inventory_update_payload(self, item_status='ONEONLY', sku='ASDF123-299',
                                 item_id=None, hw_model=None,
                                 hw_number=None, mac_address=None,
                                 storage_capacity=None, remarks=None,
                                 storage_array_model=None,
...
class SeedJobServicePayload(object):
    ...
    def create_seed_job_payload(self, seed_job_name='TestBackup20',
                                job_type='BOX',
                                target_system_id
                                ='0f9dcceb-926c-4b0e-be63-785d26edc8a1',
                                address_title=1111, description='Thisistestjob',
                                source_system_id
                                ='86dc65e4-42a0-4ee8-91e8-f201678f53aa',
                                max_data_size=50,
                                email_id='emanohar80@gmail.com',
                                job_complete=True, job_approved=False,
                                box_shipped=False, ready_to_restore=False,
                                data_erased=False, box_prepared=False,
                                box_in_transit=False, box_at_switch=False,
                                box_del_to_cust=False, data_restored=False,
                                optional_email_id
                                ='eethakatla.manohar@opcito.com'):
    ...
    def update_seed_job_payload(self,
                                ...
                                target_system_id
                                ='0f9dcceb-926c-4b0e-be63-785d26edc8a1',
                                seeding_type='new', job_complete=True,
                                job_approved=False, box_shipped=False,
                                ready_to_restore=False, data_erased=False,
                                box_prepared=False, box_in_transit=False,
                                box_at_switch=False, box_del_to_cust=False,
                                data_restored=False, source_selections="test"):
