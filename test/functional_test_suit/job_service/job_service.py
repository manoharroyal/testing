...
class JobServiceTestCases(unittest.TestCase):
    ...
    def test_create_job_with_valid_details(self):
        ...
        self.assertEquals(create_job_response.status_code, 200, 
                          msg="Expected code is 200 and got is %s" %
                              create_job_response.status_code)
        self.assertIn(create_job_response_dict.keys, expected_dict.keys, 
                      msg="Expected %s in %s" % 
    ...
    def test_create_job_with_invalid_source_system_id(self):
        ...
        self.assertEquals(create_job_response.status_code, 403, 
                          msg="Expected code is 403 and got is %s" %
                              create_job_response.status_code)
        self.assertIn(error_message, create_job_response_dict['message'], 
                      msg="Expected %s in %s" % 
    ...
    def test_create_job_with_empty_seed_job_name(self):
        ...
        self.assertEquals(create_job_response.status_code, 400, 
                          msg="Expected code is 400 and got is %s" %
                              create_job_response.status_code)
        self.assertEquals(create_job_response_dict['message'], error_message,
                          msg="Expected %s in %s" %
                              (error_message,
                               create_job_response_dict['message']))
    ...
    def test_create_job_withresponse_email_id(self):
    ...
    def test_create_job_withresponse_optional_email_id(self):
        ...
        expected_dict = SeedJobServicePayload().expected_payload()
        create_job_response_dict = create_job_response.json()
        self.assertEquals(create_job_response.status_code, 201,
                          msg="Expected code is 200 and got is %s" %
                              create_job_response.status_code)
    ...
    def test_list_seed_jobs_with_valid_url(self):
        ...
        self.assertEquals(job_lists_response.status_code, 200,
                          msg="Expected code is 200 and got is %s" %
                              job_lists_response.status_code)
        self.assertIn('jobs', job_lists_response.json().keys(),
                      msg="Expected %s in %s" %
    ...
    def test_list_seed_job_with_invalid_url(self):
        ...
        self.assertEquals(job_lists_response.status_code, 404,
                          msg="Expected code is 200 and got is %s" %
                              job_lists_response.status_code)
        self.assertIn('message', job_lists_response.json().keys(),
                      msg="Expected %s in %s" %
                          ('jobs', job_lists_response.json().keys()))
    ...
    def test_job_details_with_valid_job_id(self):
        ...
        self.assertIn('timeline_status', job_details_response.json().keys())
    ...
    def test_job_detail_with_invalid_job_id(self):
        ...
        self.assertEquals(job_details_response.status_code, 404,
    ...
    def test_job_details_job_detail_withresponse_job_id(self):
        """ Testing with the invalid job_id to get the details
        of the seed job """
        job_details_response = job_service.request(
        ...
        self.assertEquals(job_details_response.status_code, 404,
                          msg="Expected code is 404 and got is %s" %
                              job_details_response.status_code)
        self.assertEquals(job_details_response.json()['message'], error_message,
                          msg="Expected %s in %s" %
                              (error_message,
                               job_details_response.json()['message']))
    ...
    def test_job_update_with_valid_job_id(self):
        ...
        self.assertEquals(job_update_response.status_code, 202,
                          msg="Expected code is 200 and got is %s" %
    ...
    def test_job_update_with_invalid_job_id(self):
        ...
        job_update_response = job_service.request(
            ...
            payload=SeedJobServicePayload().update_seed_job_payload())
        self.assertEquals(job_update_response.status_code, 404,
                          msg="Expected code is 200 and got is %s" %
                              job_update_response.status_code)

    def test_job_update_withresponse_job_id(self):
        """ Testing without job_id to update the details of seed_job """
        job_update_response = job_service.request(
            RequestType.PUT, seed_job_url(''),
            payload=SeedJobServicePayload().update_seed_job_payload())
        self.assertEquals(job_update_response.status_code, 403,
                          msg="Expected code is 200 and got is %s" %
                              job_update_response.status_code)
    ...
    def test_job_update_with_invalid_source_system_id(self):
        ...
        self.assertEquals(job_update_response.status_code, 400,
                          msg="Expected code is 200 and got is %s" %
                              job_update_response.status_code)
    ...
    def test_delete_job_with_valid_job_id(self):
        ...
        self.assertEquals(job_delete_response.status_code, 200,
                          msg="Expected code is 200 and got is %s" %
                              job_delete_response.status_code)
        self.assertEquals(job_delete_response_dict['message'], message)
    ...
    def test_delete_job_with_invalid_job_id(self):
        ...
        self.assertEquals(job_delete_response.status_code, 404,
                          msg="Expected code is 200 and got is %s" %
                              job_delete_response.status_code)
        self.assertEquals(job_delete_response_dict['message'], error_message)
    ...
    def test_delete_job_with_response_job_id(self):
        ...
        job_delete_response = job_service.request(RequestType.DELETE,
                                                  seed_job_url(''))
        job_delete_response_dict = job_delete_response.json()
        self.assertEquals(job_delete_response.status_code, 403,
                          msg="Expected code is 200 and got is %s" %
                              job_delete_response.status_code)
        self.assertIn('message', job_delete_response_dict.keys())
    ...
    def test_action_with_valid_id(self):
        ...
        self.assertEquals(user_action_response.status_code, 202,
                          msg="Expected code is 200 and got is %s" %
    ...
    def test_action_with_invalid_id(self):
        ...
        self.assertEquals(user_action_response.status_code, 404,
                          msg="Expected code is 200 and got is %s" %
                              user_action_response.status_code)
        self.assertEquals(user_action_response_dict['message'], message)
    ...
    def test_action_with_empty_id(self):
        ...
        self.assertEquals(user_action_response.status_code, 403,
                          msg="Expected code is 200 and got is %s" %
                              user_action_response.status_code)
        self.assertEquals(user_action_response_dict['message'], message)
    ...
    def test_action_with_incorrect_db_user_name(self):
        ...
        self.assertEquals(user_action_response.status_code, 400,
                          msg="Expected code is 200 and got is %s" %
                              user_action_response.status_code)
        self.assertEquals(user_action_response_dict['message'], message)
    ...
    def test_approve_job_with_valid_details(self):
        ...
        approve_job_response = job_service_admin.request(
            RequestType.PUT, admin_action_url(SEED_JOB_ID, 'approve'),
            payload=SeedJobServicePayload().approve_payload())
        self.assertEquals(approve_job_response.status_code, 200,
                          msg="Expected code is 200 and got is %s" %
    ...
    def test_approve_job_with_invalid_job_id(self):
        ...
        self.assertEquals(approve_job_response.status_code, 404,
                          msg="Expected code is 404 and got is %s" %
                              approve_job_response.status_code)
        self.assertEquals(approve_job_response_dict['message'], message)
    ...
    def test_approve_job_with_empty_job_id(self):
        ...
        self.assertEquals(approve_job_response.status_code, 401,
    ...
    def test_agent_action_with_valid_job_id(self):
        ...
        self.assertEquals(agent_action_response.status_code, 200,
                          msg="Expected code is 200 and got is %s" %
    ...
    def test_agent_actio_with_invalid_job_id(self):
        ...
        self.assertEquals(agent_action_response.status_code, 404,
                          msg="Expected code is 404 and got is %s" %
                              agent_action_response.status_code)
        self.assertEquals(agent_action_response_dict['message'], message)

    def test_agent_actio_withresponse_source_objects(self):
        ...
        self.assertEquals(agent_action_response.status_code, 400,
                          msg="Expected code is 400 and got is %s" %
                              agent_action_response.status_code)
        self.assertEquals(agent_action_response_dict['message'], message)
    ...
    def test_update_job_logs_with_valid_job_id(self):
        ...
        self.assertEquals(update_job_logs_response.status_code, 202,
                          msg="Expected code is 202 and got is %s" %
                              update_job_logs_response.status_code)
        self.assertEquals(update_job_logs_response_dict['message'], message)
    ...
    def test_update_job_logs_with_invalid_job_id(self):
        ...
        update_job_logs_response = job_service_agent.request(
            ...
            payload=SeedJobServicePayload().update_job_logs())
        self.assertEquals(update_job_logs_response.status_code, 403,
                          msg="Expected code is 403 and got is %s" %
                              update_job_logs_response.status_code)
