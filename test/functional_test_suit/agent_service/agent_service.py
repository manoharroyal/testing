...
class AgentServiceTestCases(unittest.TestCase):
    ...
    def test_list_agents_with_valid_url(self):
        ...
        list_agents_response = agent_service_admin.request(
            RequestType.GET, AGENT_SERVICE_URL)
        list_agents_response_dict = list_agents_response.json()
        self.assertEquals(list_agents_response.status_code, 200,
    ...
    def test_list_agent_with_invalid_url(self):
        ...
        list_agents_response_dict = list_agents_response.json()
        self.assertEquals(list_agents_response.status_code, 403,
    ...
    def test_list_agent_tasks_with_valid_url(self):
        ...
        self.assertEquals(list_agents_tasks_response.status_code, 200,
                          msg="Expected response code is 200 and got is %s" %
    ...
    def test_list_agent_tasks_with_invalid_url(self):
        ...
        list_agents_response = agent_service_agent.request(
        ...
        self.assertEquals(list_agents_response.status_code, 404,
    ...
    def test_update_agent_task_with_valid_task_id(self):
        ...
        self.assertEquals(update_agent_task_response.status_code, 202,
    ...
    def test_register_agent_with_valid_url(self):
        ...
        self.assertEquals(register_agent_response.status_code, 202,
                          msg="Expected response code is 202 and got is %s" %
    ...
    def test_register_agent_with_invalid_url(self):
        ...
        self.assertEquals(register_agent_response.status_code, 403,
                          msg="Expected response code is 403 and got is %s" %
                              register_agent_response.status_code)
        self.assertIn('message', register_agent_response_dict.keys(),
                      msg="Expected %s in %s" %
    ...
    def test_agent_task_details_with_valid_task_id(self):
        ...
        self.assertEquals(agent_task_details_response.status_code, 200,
                          msg="Expected response code is 200 and got is %s" %
    ...
    def test_agent_task_details_with_invalid_task_id(self):
        ...
        self.assertEquals(agent_task_details_response.status_code, 401,
    ...
    def test_agent_details_with_valid_agent_id(self):
        ...
        self.assertEquals(agent_details_response.status_code, 200,
                          msg="Expected response code is 200 and got is %s" %
    ...
    def test_agent_details_with_invalid_agent_id(self):
        ...
        self.assertEquals(agent_details_response.status_code, 404,
                          msg="Expected response code is 404 and got is %s" %
                              agent_details_response.status_code)
        self.assertIn(
    ...
    def test_agent_details_without_agent_id(self):
        ...
        self.assertEquals(agent_details_response.status_code, 401,
                          msg="Expected response code is 401 and got is %s" %
                              agent_details_response.status_code)
        self.assertIn(
            expected_message, agent_details_response_dict['message'],
